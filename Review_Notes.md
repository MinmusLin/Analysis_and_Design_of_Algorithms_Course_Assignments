...
* $O(g(n))$ ：存在某个正常数和某个非负整数使得，对于所有 $n≥n_0$ 有 $t(n)≤c \cdot g(n)$ （低阶或同阶增长）

  ![](assets/2024-06-23_11-55-12.png)

* $Ω(g(n))$ ：存在某个正常数和某个非负整数使得，对于所有 $n≥n_0$ 有 $t(n)≥c \cdot g(n)$ （高阶或同阶增长）

  ![](assets/2024-06-23_11-55-51.png)

* $Θ(g(n))$ ：存在某两个正常数和某个非负整数使得，对于所有 $n≥n_0$ 有 $c_2 \cdot g(n)≤t(n)≤c_1 \cdot g(n)$ （同阶增长）
